...
// Configurações AJAX ----------------------------------------------------------------------------------------------- //
define('TXT_AJAX_SALVANDO_REGISTRO', 'Salvando esse registro... Por favor, aguarde!');
define('TXT_AJAX_EXCLUINDO_REGISTROS', 'Excluindo registro(s)... Por favor, aguarde!');
define('TXT_AJAX_ENVIANDO_EMAIL', 'Enviando email... Por favor, agurade!');
define('TXT_AJAX_ACESSANDO', 'Acessando o sistema... Por favor, agurade!');
define('TXT_AJAX_ENCERRANDO_SESSAO', 'Encerrando essa sessão... Por favor, aguarde!');
define('TXT_AJAX_PUBLICANDO_REGISTRO', 'Publicando registro(s)... Por favor, aguarde!');
define('TXT_AJAX_OCULTANDO_REGISTRO', 'Ocultando registro(s)... Por favor, aguarde!');
define('TXT_AJAX_SALVANDO_ARQUIVO', 'Salvando o(s) arquivos(s)... Por favor, agurade!');
