...
define('TXT_ROTULO_DIRETORIO', 'Directory');
define('TXT_ROTULO_PADRAO', 'Default?');
...
define('TXT_LINK_NOVO_METODO', 'New method');



/**
 * \Desenvolvedor\Controle\Modulo
 * -----------------------------------------------------------------------------
 */
# Sucessos
